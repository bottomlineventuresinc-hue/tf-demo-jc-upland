/* Template Factory - JC Construction live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-jc-upland/';
  var LS_CHANGES = 'tf_jc_change_log_v1';
  var LS_PURCHASED = 'tf_jc_purchased_v1';
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for JC Construction. Hang tight.',
        delay,
        function () {
